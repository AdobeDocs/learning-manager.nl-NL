...
Dankzij de niet-aangemelde ervaring kunt u leerervaringen creëren voor niet-aangemelde gebruikers. Een niet-aangemelde ervaring fungeert bijvoorbeeld als startpagina voor marketingcampagnes om aanmelding-ups te stimuleren.
...
Het premieaanbieden helpt gebruikers een headless interface bouwen, die door de **[!UICONTROL schakelaar van de Toegang van de Gegevens van de Opleiding]** wordt gevormd. Voor overvloeiingsscenario&#39;s krijgt u ook real-time beperkingen voor licenties, bezette plaatsen, wachtlijstlimieten en wachtlijstaantallen. Klanten kunnen deze API&#39;s gebruiken om zoek- en filtermogelijkheden en een volledig cursusoverzicht voor niet-aangemelde studenten te maken.
