...
De zoekfunctie in Adobe Learning Manager verbetert de gebruikerservaring doordat gebruikers relevante inhoud efficiënt kunnen vinden en de juiste inhoud kunnen consumeren.

Adobe Learning Manager introduceert een door AI gedreven zoekfunctie waarin lexicale en semantische zoekopdrachten worden gecombineerd. Dankzij deze verbeterde functionaliteit kunnen studenten relevante inhoud efficiënt vinden. De geavanceerde AI-zoekfunctie begrijpt de betekenis van je zoekopdracht en levert relevante resultaten op.

## Belangrijkste voordelen

* **Slimmer onderzoek**: Begrijp de context en de bedoeling achter onderzoekstermijnen
* **Verbeterde relevantie**: Verstrekt resultaten die op de betekenis van uw vraag worden gebaseerd
* **Verbeterde gebruikerservaring**: Helpt studenten de juiste inhoud te gebruiken
...
* **Ervaring van de Gebruiker**: Verbetert gebruikerstevredenheid door snelle informatieherwinning toe te laten
* **Efficiëntie**: Bespaar tijd door inspanning te verminderen om van specifieke inhoud de plaats te bepalen.
...
Terwijl mensen online zoeken, verandert de manier waarop ze zoeken, en zoekmachines passen zich aan om het bij te houden. Hieronder volgen enkele belangrijke manieren waarop mensen de laatste tijd naar informatie zoeken:
...
Adobe Learning Manager biedt een slimmere, geavanceerdere zoekervaring. Het komt niet alleen overeen met trefwoorden, maar begrijpt ook contextueel de betekenis van gebruikersquery&#39;s om de meest relevante resultaten te vinden.
...
Adobe Learning Manager beschikt over verbeterde zoekmogelijkheden waarmee gebruikers kunnen zoeken binnen de feitelijke inhoud van verschillende bestandstypen, zoals video&#39;s, audiobestanden, PDF, documenten, presentaties en spreadsheets. Het systeem transcripteert deze inhoud automatisch om uitgebreidere en nauwkeurigere zoekresultaten te bieden. Bovendien worden opnamen van Adobe Connect-vergaderingen opgenomen in de zoekopdracht, zodat waardevolle informatie niet wordt gemist. Als er een overeenkomst wordt gevonden binnen de inhoud, wordt de positie van die inhoud in de uiteindelijke resultaten door het zoekmodel versterkt. De definitieve rangschikking wordt bepaald door veelvoudige factoren, zoals geschetst in de [&#x200B; AI-Aangedreven onderzoek en re-rangschikking &#x200B;](/help/migrated/learners/feature-summary/advanced-search.md#ai-powered-search-and-re-ranking) sectie.
...
Adobe Learning Manager&#39;s zoektocht leidt de industrie door traditionele en geavanceerde technologieën te combineren. Het combineert traditionele zoekmethoden zoals woordafstemming en geavanceerde semantische zoekopdrachten om uitgebreide resultaten te bereiken. Het systeem rangschikt deze resultaten op basis van sleutelfactoren zoals inschrijvingsnummers, publicatiedatums, beoordelingen en populariteit. Dit zorgt voor kwaliteitsovereenkomsten van alle indices, geleid door ons classificatiesysteem voor cursuskwaliteit.

Al met al is AI-gestuurde zoekfunctie ontworpen om grondig, nauwkeurig en gebruikersvriendelijk te zijn, zodat studenten snel de resources kunnen vinden die nodig zijn om hun leertraject te ondersteunen.
