...
*Toegewezen cursussen weergeven*
...
*Een voltooide cursus weergeven*
...
*Effectiviteitsscore van cursus bekijken*
...
Op de pagina met zoekresultaten kunt u de cursussen filteren op basis van de **duur** van de cursussen en **format** van de cursussen. Dit biedt meer flexibiliteit tijdens het zoeken naar cursussen en zorgt ervoor dat u de cursussen vindt die bij u passen.
...
1. Studenten kunnen zichzelf rechtstreeks inschrijven voor een cursus/leerprogramma:
   ...
   1. Als de cursus/het leerprogramma van het door de manager goedgekeurde type is, gaat de student naar **goedkeuring in behandeling** status. Na goedkeuring door de manager wordt de student voor de cursus ingeschreven.
...
Als student kunt u een cursus pas beoordelen na uw inschrijving. U kunt de gemiddelde sterrenwaarderingen voor elke cursus zien op het tabblad **Home** Pagina, **Mijn leerervaring** pagina en **Catalogus**.

1. Aanmelden als een **Student**. Hierdoor wordt het **Startpagina**.

1. Zoek een cursus door de cursusnaam in de zoekbalk in te voeren. U kunt ook een keuze maken in de weergegeven cursuslijst door op **Mijn leerervaring** of **Catalogus** in het linkerdeelvenster.

1. Klik na het selecteren van een cursus op **[!UICONTROL Inschrijven]**.

   ![](assets/cp-sr-enroll.png)
   *Inschrijven voor een cursus*

1. Selecteer het aantal sterren om een cursus dienovereenkomstig te beoordelen, waarbij 1 de laagste waardering en 5 de hoogste waardering is. Klik vervolgens op **[!UICONTROL Verzenden]**.

   ![](assets/cp-sr-srsubmitt.png)
   *Cursusbeoordeling verzenden*
...
1. Na het indienen wordt er een bevestigingsbericht weergegeven.
   ...
   ![](assets/cp-sr-dm.png)
   *Bevestigingsbericht voor feedback*
...
Cursussen kunnen worden gesorteerd op basis van de gemiddelde waarderingen. U kunt de gevallen sorteren in het vervolgkeuzemenu Sorteren op rechtsboven in het dialoogvenster **Catalogus**.

## Een cursus volgen {#consumingnbspacourse}

Nadat u zich voor een cursus hebt ingeschreven, kunt u de cursus volgen door op de cursus op Start te klikken. U kunt ook op **[!UICONTROL Cursussen]** in **[!UICONTROL Leren]** tabblad. Kies een cursus die u interesseert.
...
**inhoudsopgave** - Wanneer u een cursus volgt, geeft de speler een inhoudsopgave voor die specifieke cursus weer in het linkerdeelvenster van het venster. U kunt op een willekeurig onderwerp klikken om hier direct naartoe te gaan.

**Bladwijzers** - Als een van de cursusmodules een module-inhoudsopgave heeft, kunnen onderwerpen in de module-inhoudsopgave als referentie worden gemarkeerd. Wanneer er een zwart lintje bij een ingang in de inhoudsopgave staat, is er een bladwijzer aan de ingang gekoppeld. Klik nogmaals op dit lintje om een bladwijzer te verwijderen.
...
**Ondertiteling** - Als voor door Adobe Captivate ontwikkelde cursussen de ondertitels zijn ingeschakeld tijdens de ontwikkeling van de cursus, kan de student de bijschriften bekijken. Klik op CC onderaan de speler. De ondertitelingsoptie is alleen beschikbaar voor Captivate 8.0.2 HTML-inhoud. Voor alle andere modules staat de CC-optie niet op de afspeelbalk.
...
*Nadat u de cursus hebt afgesloten, kunt u de cursus opnieuw openen door op de knop Opnieuw bekijken op de pagina met de cursusbeschrijving te klikken.*
...
*Geef sterrenclassificatie op als feedback*
...
![](assets/catalog.png)
*Cursus voorvertonen in Marketplace*

Wanneer de Beheerder u uitnodigt om een groot aantal cursussen te verkennen en te bekijken, ziet u een melding.

Als student kunt u interesse tonen voor een volledige catalogus of een beheerde afspeellijst in de **Gecurreerde afspeellijst** sectie.

![](assets/curated-playlist.png)
*Beheerde afspeellijst weergeven*
...
1. Kies met de keuzerondjes of u alle cursussen of cursussen met niet-geselecteerde exemplaren wilt bekijken. Let op: als de student het exemplaar heeft voltooid, kan hij niet overschakelen naar een andere instantie.
   ...
   *Alle cursussen of cursussen met niet-geselecteerde instanties weergeven*
...
**Gearchiveerd** - Een auteur kan een cursus na publicatie archiveren als hij niet wil dat de cursus in de cursuscatalogus voor studenten verschijnt.
...
*Overzicht van de levenscyclus van een cursus*
