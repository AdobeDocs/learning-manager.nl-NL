...
* Als u geen toegang hebt tot een cursus, taakhulp of leerobject, gebruikt de assistent deze niet om reacties te genereren.
...
* Er wordt geen inhoud gebruikt uit Gedeelde, Opgehaalde, Externe of andere niet-interne catalogi.
