...
+++Update 103: Adobe Learning Manager-versie van november 2025

Releasedatum: woensdag 25 november 2025

## Nieuw in deze release

### Experience Builder

Experience Builder is nu beschikbaar voor alle Adobe Learning Manager-accounts, waardoor klanten volledig merkgebonden leerervaringen kunnen creëren met behulp van low-code componenten en flexibele lay-outs. Met Experience Builder kunnen beheerders aangepaste leerportalen en pagina&#39;s maken die volledig mobiel-responsief zijn.

Voor bestaande accounts wordt de Experience Builder-update automatisch geïmplementeerd. De functie Experience Builder is niet beschikbaar voor accounts die de oude gebruikersinterface of de klassieke gebruikersinterface blijven gebruiken.

De Bouwer van de Ervaring van de mening [ voor meer informatie.](/help/migrated/administrators/feature-summary/experience-builder/overview.md)

### Adobe Learning Manager mobiele webinterface

De mobiele webinterface is vernieuwd op basis van een moderne codebase voor snellere laadtijden, verbeterde responsiviteit en een intuïtievere leerervaring op verschillende apparaten.

De bijgewerkte mobiele webervaring is standaard ingeschakeld voor alle nieuwe accounts. Bestaande accounts ontvangen de upgrade ook automatisch, behalve als Sociaal leren is ingeschakeld. In die gevallen blijft de eerdere mobiele ervaring actief totdat Sociaal leren is gemigreerd naar het nieuwe compatibele framework.

>[!NOTE]
>
>Sociaal leren wordt niet ondersteund in de nieuwe mobiele webinterface van Adobe Learning Manager.

### Verbeteringen in Fluidic Player

Voorheen werd met de knop Volgende in de Fluidic Player de titel van de volgende module niet weergegeven, waardoor studenten moeilijk konden anticiperen op de volgende stap in hun leertraject.

Dankzij deze verbetering bevat de knop Volgende nu de titel van de volgende module, zodat studenten het volgende kunnen doen:

* Begrijp welke inhoud naar boven komt voordat ze verdergaan.
* Navigeer met meer helderheid en vertrouwen door modules.
* Houd een betere context gedurende de cursus.

![](assets/fluidic-player-next.png)
_de Fluidic Player toont nu de Volgende knoop met de titel van de aanstaande module_

### L1-feedbackformulier

L1-feedback kan alleen worden geconfigureerd binnen afzonderlijke leerobjecten, waardoor de flexibiliteit beperkt is en beheerders niet verschillende formulieren in de catalogus kunnen gebruiken. Beheerders kunnen nu meerdere L1-feedbackformulieren maken en gebruiken en elk feedbackformulier kan worden toegewezen aan specifieke cursussen, leerpaden en certificeringen. Het formulier ondersteunt nu meerdere vraagtypen, zoals cursuseffectiviteit, NPS, Likert-schaal en Free Text-vragen.

Feedbackformulieren kunnen in andere talen worden vertaald, terwijl voor alle landinstellingen dezelfde vraagstructuur behouden blijft. Rapporten bevatten nu Naam feedbackformulier en Versie feedbackformulier om te bepalen welk formulier elke reactie heeft vastgelegd.

**gevallen van het Gebruik**

* Wijs feedbackformulieren op maat toe aan verschillende trainingsprogramma&#39;s. Verkoopcursussen kunnen bijvoorbeeld op NPS gerichte vragen gebruiken, terwijl nalevingscursussen Cursuseffectiviteit en Likert-schaal vragen kunnen gebruiken om helderheid en beleidsbegrip te meten.
* Gebruik aparte feedbackformulieren op basis van leermodules. Bijvoorbeeld drie verschillende vormen voor overvloeimodules, modules op eigen tempo en klassikale modules.

De mening [ L1 terugkoppelt vorm ](/help/migrated/administrators/feature-summary/l1-feedback-form.md) voor meer informatie.
...
Als het de bedoeling is om studenten maar geen managers (bijvoorbeeld cursusinschrijving) via e-mail te sturen, verzendt de huidige sjabloon e-mails naar alle rollen.
...
In de studenttranscripten zijn in de tijdkolommen de minuten afgerond tot de dichtstbijzijnde minuut en is de secondewaarde 00. Zie [***Tijdkolommen***](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md) voor meer informatie.
...
* Download Studenttranscripten voor verwijderde gebruikers. Zie [***Studenttranscripten***](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md) voor meer informatie.
...
U ontmoet een fout wanneer u probeerde om de informatie van de moduleversie te halen gebruikend AP/cursussen/{coursesid}. Dit is nu opgelost.
...
Learning Manager biedt u een functie om transcripten te genereren voor de Learning Manager-studenten in uw organisatie. Voor meer informatie, verwijs naar [ de inhoud van de de eigenschaphulp van de Transcripten van de Student ](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md).
...
In studentenlogin, de het hulpmiddeluiteinde van de vaardigheidsnaam in **kaart van Vaardigheden** toonde niet de volledige naam. Dit probleem is opgelost.
