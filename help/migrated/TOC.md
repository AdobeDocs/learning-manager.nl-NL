...
* [Gebruikershandleiding voor Learning Manager](user-guide.md)
* Inleiding {#introduction}
   ...
   * [Opmerkingen bij de release](release-note/release-notes.md)
   ...
   * [Compatibiliteit van Learning Manager met AVG](kb/prime-gdpr.md)
   * [Toegankelijkheid in Leerbeheer](accessibility-learning-manager.md)
...
* Beheerder {#admin}
   ...
   * [Locaties voor lesruimten toevoegen](administrators/feature-summary/classroom.md)
   * [Cursusmodules, instanties en leerprogramma&#39;s maken](administrators/feature-summary/courses.md)
   * [Contentmarktplaats](administrators/feature-summary/content-marketplace.md)
   ...
   * [Bestellingen en facturering van Leermanager beheren](administrators/feature-summary/billing-management.md)
   ...
   * [Een student en manager personaliseren](administrators/feature-summary/impersonation-learner-manager.md)
   ...
   * [Op AI gebaseerde aanbeveling van cursussen](ai-based-recommendations.md)
   * [Gamification](administrators/feature-summary/gamification.md)
   * [De startpagina van studenten aanpassen](administrators/feature-summary/customize-learner-homepage.md)
   * [Badges](administrators/feature-summary/badges.md)
   * [Kleurthema&#39;s](administrators/feature-summary/themes.md)
   ...
   * [Aan de slag als beheerder](administrators/feature-summary/getting-started.md)
   * [Gebruikers leegmaken](administrators/feature-summary/purge-users.md)
   * [Labels](administrators/feature-summary/tags.md)
   * [Inhoudscatalogus van Learning Manager](administrators/feature-summary/content-catalogs.md)
   ...
   * [Sociaal leren bewaken en modereren als beheerder](administrators/feature-summary/social-learning-configurations-as-an-admin.md)
   ...
   * [Native uitbreidbaarheid](administrators/feature-summary/native-extensibility.md)
...
* Integratiebeheerder {#integration}
   ...
   * [Connectoren van Learning Manager](integration-admin/feature-summary/connectors.md)
   * [Integreer Learning Manager met AEM](integrate-aem-learning-manager.md)
   * [Salesforce-pakket installeren in Learning Manager](integration-admin/feature-summary/install-salesforce-package.md)
   ...
   * [Aangepaste rollen beheren via CSV-bestanden](integration-admin/feature-summary/configure-role-csv-files.md)
* Auteurs {#authors}
   * [Gebruikersaanmelding](authors/feature-summary/user-login.md)
   * [Inhoudsbibliotheek](authors/feature-summary/content-library.md)
   * [Cursussen maken, wijzigen en publiceren](authors/feature-summary/courses.md)
   ...
   * [Leerobjecten toevoegen in verschillende landinstellingen](authors/feature-summary/add-new-language-learning-objects.md)
   ...
   * [Hoe kies ik cursusmodules?](authors/how-to-choose-modules.md)
   * [Voorvertonen als student](authors/feature-summary/fluidic-player.md)
   * [Instellingen](authors/feature-summary/settings.md)
* Docent {#instructor}
   * [Modules](instructors/feature-summary/modules.md)
   * [Studenten voor uw sessie beheren](instructors/feature-summary/learners.md)
* Student {#learner}
   ...
   * [Adobe Learning Manager-bureaubladtoepassing](learners/adobe-learning-manager-app-for-desktop.md)
   ...
   * [Systeemvereisten | Adobe Learning Manager-bureaubladtoepassing](learners/adobe-learning-manager-app-for-desktop/adobe-learning-manager-desktop-app-system-requirements.md)
* Manager {#manager}
...
* Knowledge Base {#knowledge-base}
   * [Aanmelden bij Leermanager mislukt](kb/unable-log-in-learning-manager.md)
   * [Het leeroverzicht geeft de huidige gegevens niet weer](kb/learning-summary-not-display-data.md)
   * [Kan een CSV niet uploaden](kb/unable-to-upload-csv.md)
   * [Een HAR-bestand genereren](kb/generate-har-file.md)
   * [L1-feedback automatisch pop-upmenu verschijnt niet](kb/l1-feedback-auto-popup-does-not-appear.md)
   * [Kan bepaalde cursussen niet weergeven onder catalogus tijdens het maken van een certificering](kb/unable-to-view-certain-courses.md)
   * [Kan bepaalde cursus niet weergeven onder catalogus tijdens het maken van een leerprogramma](kb/unable-view-course-catalog.md)
   ...
   * [Kan niet zoeken in een cursus](kb/unable-to-search-course.md)
   * [Migratieproblemen oplossen](kb/troubleshooting-migration.md)
   * [Problemen met de app voor Learning Manager oplossen](kb/troubleshooting-issues-with-adobe-learning-manager-desktop-app.md)
   * [Gebruikers worden automatisch verwijderd in Leerbeheer](kb/auto-delete.md)
   * [Publicatie van publicaties op EU-niveau](kb/publish-issue-eu-domain.md)
   * [Kan niet registreren als externe gebruiker](kb/register-issue-external-user.md)
   * [Integratie van Okta Active Directory met Adobe Learning Manager](kb/okta-active-directory-integration.md)
   * [Kan de studenten in een cursus niet weergeven](kb/unable-view-learners-course.md)
   * [Kan agenda niet weergeven](kb/unable-view-calendar.md)
   * [Module is niet als voltooid gemarkeerd na voltooiing van een cursus](kb/module-not-marked-complete.md)
   * [Kan geen vaardigheid bereiken na voltooiing van een cursus](kb/skill-not-achieved.md)
   * [Keuzerondjes ontbreken](kb/selection-button-invisible.md)
   * [Kan geen inzendingen weergeven in Learning Manager](kb/unable-to-view-submitted-file.md)
